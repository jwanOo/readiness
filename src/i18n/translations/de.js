/**
 * German translations for AI Readiness Check
 */
export default {
  // ═══════════════════════════════════════════════════════════════
  // COMMON UI STRINGS
  ...
  navigation: {
    ...
    backToSelection: "← Branchenauswahl",
  },
  ...
  // ═══════════════════════════════════════════════════════════════
  industrySelection: {
    title: "Branchenspezifischer AI Readiness Check",
    subtitle: "Wählen Sie die Branche Ihres Kunden — basierend auf dem vollständigen adesso-Branchenportfolio für Deutschland und die Schweiz.",
    filters: {
      country: "Land:",
      allCountries: "🇩🇪🇨🇭 Alle",
      germany: "🇩🇪 Deutschland",
    ...
    noResults: "Keine Branchen für den gewählten Filter gefunden.",
    continueWithout: "Ohne Branchenauswahl fortfahren →",
  ...
  // ═══════════════════════════════════════════════════════════════
  configuration: {
    title: "Assessment konfigurieren",
    industryQuestions: "Branchenspezifische Fragen",
    additionalQuestions: "{{count}} zusätzliche Fragen",
    standardSections: "📋 Standardabschnitte",
    totalQuestions: "Gesamt: {{count}} Fragen in {{sections}} Abschnitten",
  ...
  // ═══════════════════════════════════════════════════════════════
  questionnaire: {
    progress: "{{answered}}/{{total}} beantwortet",
    ...
    readOnlyNotice: "Dieser Abschnitt ist für Sie schreibgeschützt",
    readOnlyDescription: "Sie können die Antworten einsehen, aber nicht bearbeiten. Nur zugewiesene Team-Mitglieder oder der Assessment-Ersteller können diesen Abschnitt bearbeiten.",
    placeholder: {
      text: "Bitte eingeben...",
      textarea: "Bitte beschreiben...",
    },
    navigation: {
  ...
  // ═══════════════════════════════════════════════════════════════
  summary: {
    title: "Readiness Check Zusammenfassung",
    subtitle: "{{industry}} — {{date}} — {{answered}}/{{total}} beantwortet",
    assessment: {
      title: "🎯 AI Readiness Assessment",
      subtitle: "Automatische Bewertung basierend auf Ihren Antworten",
      overallRating: "Gesamtbewertung AI Readiness",
      aiReady: "Ihr Unternehmen ist gut für SAP Business AI aufgestellt",
      partiallyReady: "Grundlagen vorhanden — gezielte Maßnahmen empfohlen",
      notReady: "Erheblicher Handlungsbedarf vor KI-Einführung",
    },
    scores: {
    ...
    export: {
      ...
      changeLanguage: "Sprache oben ändern",
      wordExport: "Word exportieren (.doc)",
      pdfExport: "PDF exportieren",
      pptxExport: "PowerPoint exportieren",
      wordHint: "Word-Datei wird direkt heruntergeladen. PDF öffnet den Druckdialog — wählen Sie dort \"Als PDF speichern\".",
    },
  ...
  aiRecommendations: {
    ...
    subtitle: "Personalisierte Handlungsempfehlungen basierend auf Ihren Assessment-Antworten",
    aiGenerated: "KI-generiert",
    loading: "Empfehlungen werden generiert...",
  ...
  dashboard: {
    ...
    subtitle: "Verwalten und verfolgen Sie Ihre Kunden-Assessments",
    newAssessment: "+ Neues Assessment",
    searchPlaceholder: "Assessments suchen...",
    filters: {
      all: "Alle",
      draft: "Entwurf",
      inProgress: "In Bearbeitung",
    ...
    empty: {
      ...
      subtitle: "Erstellen Sie Ihr erstes AI Readiness Assessment, um zu beginnen.",
      cta: "Assessment erstellen",
    },
    actions: {
      continue: "Fortsetzen",
      view: "Ansehen",
  ...
  // ═══════════════════════════════════════════════════════════════
  teamAssignment: {
    title: "👥 Team-Zuweisung für diesen Abschnitt",
    selectMembers: "Team-Mitglieder auswählen...",
    searchPlaceholder: "Name oder E-Mail suchen...",
    noResults: "Keine Personen gefunden",
    assigned: "{{count}} Person(en) zugewiesen",
  },
  ...
  industries: {
    insurance: {
      ...
      sections: [
        {
          title: "SAP & Versicherungssysteme",
          questions: [
        ...
        {
          title: "KI-spezifisch für Versicherungen",
          questions: [
    ...
    banking: {
      ...
      sections: [
        {
          title: "SAP-Systemlandschaft Banking",
          questions: [
        ...
        {
          title: "KI-spezifisch für Banking",
          questions: [
    ...
    healthcare: {
      ...
      sections: [
        ...
        {
          title: "KI-spezifisch für Gesundheitswesen",
          questions: [
    ...
    automotive: {
      ...
      sections: [
        {
          title: "SAP-Systemlandschaft Automotive",
          questions: [
        ...
        {
          title: "KI-spezifisch für Automotive",
          questions: [
    ...
    manufacturing: {
      ...
      sections: [
        {
          title: "SAP-Systemlandschaft Fertigung",
          questions: [
        ...
        {
          title: "KI-spezifisch für Fertigung",
          questions: [
    ...
    retail: {
      ...
      sections: [
        {
          title: "SAP-Systemlandschaft Handel",
          questions: [
        ...
        {
          title: "KI-spezifisch für Handel",
          questions: [
    ...
    energy: {
      ...
      sections: [
        {
          title: "SAP-Systemlandschaft Energie",
          questions: [
        ...
        {
          title: "KI-spezifisch für Energie",
          questions: [
    ...
    publicSector: {
      ...
      sections: [
        {
          title: "SAP-Systemlandschaft Public",
          questions: [
        ...
        {
          title: "KI-spezifisch für Öffentlichen Sektor",
          questions: [
    ...
    lifeSciences: {
      ...
      sections: [
        {
          title: "SAP-Systemlandschaft Life Sciences",
          questions: [
        ...
        {
          title: "KI-spezifisch für Life Sciences",
          questions: [
    ...
    lottery: {
      ...
      sections: [
        ...
        {
          title: "KI-spezifisch für Lotterie",
          questions: [
    ...
    transport: {
      ...
      sections: [
        ...
        {
          title: "KI-spezifisch für Verkehr & Logistik",
          questions: [
    ...
    media: {
      ...
      sections: [
        ...
        {
          title: "KI-spezifisch für Medien",
          questions: [
    ...
    defense: {
      ...
      sections: [
        ...
        {
          title: "KI-spezifisch für Defense",
          questions: [
    ...
    foodBeverage: {
      ...
      sections: [
        {
          title: "KI-spezifisch für Food & Beverage",
          questions: [
    ...
    construction: {
      ...
      sections: [
        {
          title: "KI-spezifisch für Bau & Immobilien",
          questions: [
    ...
    tradeFairsSports: {
      ...
      sections: [
        {
          title: "KI-spezifisch für Events & Sports",
          questions: [
    ...
    telecom: {
      ...
      sections: [
        {
          title: "KI-spezifisch für Telekommunikation",
          questions: [
    ...
    professionalServices: {
      ...
      sections: [
        {
          title: "SAP-Systemlandschaft Professional Services",
          questions: [
        ...
        {
          title: "KI-spezifisch für Professional Services",
          questions: [
    ...
    chemical: {
      ...
      sections: [
        {
          title: "SAP-Systemlandschaft Chemie",
          questions: [
        ...
        {
          title: "KI-spezifisch für Chemie / Prozessindustrie",
          questions: [
  ...
  sections: {
    general: {
      ...
      questions: [
        { q: "Kundenname", hint: "" },
        { q: "Ansprechpartner", hint: "" },
        { q: "E-Mail", hint: "" },
        { q: "Berater (intern)", hint: "" },
      ]
    },
    landscape: {
